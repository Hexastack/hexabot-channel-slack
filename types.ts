...
export namespace Slack {
  ...
  export interface StaticSelectAction
    extends BasicElementAction<'static_select'> {
    selected_option: {
      text: PlainTextElement;
      value: string;
    };
  ...
  export interface MultiStaticSelectAction
    extends BasicElementAction<'multi_static_select'> {
    selected_options: {
      text: PlainTextElement;
      value: string;
    }[];
   ...
   */
  export interface UsersSelectAction
    extends BasicElementAction<'users_select'> {
  ...
  export interface MultiUsersSelectAction
    extends BasicElementAction<'multi_users_select'> {
  ...
  export interface ConversationsSelectAction
    extends BasicElementAction<'conversations_select'> {
  ...
  export interface MultiConversationsSelectAction
    extends BasicElementAction<'multi_conversations_select'> {
  ...
  export interface ChannelsSelectAction
    extends BasicElementAction<'channels_select'> {
  ...
  export interface MultiChannelsSelectAction
    extends BasicElementAction<'multi_channels_select'> {
  ...
  export interface ExternalSelectAction
    extends BasicElementAction<'external_select'> {
  ...
  export interface MultiExternalSelectAction
    extends BasicElementAction<'multi_external_select'> {
  ...
  export interface RadioButtonsAction
    extends BasicElementAction<'radio_buttons'> {
  ...
  export interface PlainTextInputAction
    extends BasicElementAction<'plain_text_input'> {
    value: string;
  }
   ...
   */
  export interface RichTextInputAction
    extends BasicElementAction<'rich_text_input'> {
  ...
  export interface UploadedFile {
    ...
    mp4?: string;
    mp4_low?: string;
    non_createdBy_editable?: boolean;
    num_stars?: number;
